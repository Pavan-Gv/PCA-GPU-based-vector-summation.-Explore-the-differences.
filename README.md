...
i) Using the program sumArraysOnGPU-timer.cu, set the block.x = 1023 & 1024. Recompile and run it. Compare the result with the execution confi guration of block.x = 1024. Try to explain the difference and the reason.
